...
# 3dpose_gan 用に17pointに変更
H36M_NAMES = ['']*17
H36M_NAMES[0]  = 'Hip' #1
H36M_NAMES[1]  = 'RHip' #2
H36M_NAMES[2]  = 'RKnee' #3
H36M_NAMES[3]  = 'RFoot' #4
H36M_NAMES[4]  = 'LHip' #7 -> 5
H36M_NAMES[5]  = 'LKnee' #8 -> 6
H36M_NAMES[6]  = 'LFoot' #9 -> 7
H36M_NAMES[7] = 'Spine' #13 -> 8
H36M_NAMES[8] = 'Thorax' #14 -> 9
H36M_NAMES[9] = 'Neck/Nose' #15 -> 10
H36M_NAMES[10] = 'Head' #16 -> 11
H36M_NAMES[11] = 'LShoulder' #18 -> 12
H36M_NAMES[12] = 'LElbow' #19 -> 13
H36M_NAMES[13] = 'LWrist' #20 -> 14
H36M_NAMES[14] = 'RShoulder' #26 -> 15
H36M_NAMES[15] = 'RElbow' #27 -> 16
H36M_NAMES[16] = 'RWrist' #28 -> 17
